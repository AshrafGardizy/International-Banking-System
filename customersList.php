...
<ul class="menu">
    ...
    <li class="current"><a href="">Customers</a>
        <ul>
            <li class="current"><a href="customersList.php"><i class="fa fa-list"></i> Customers List</a></li>
...
<div class="grid">
    <div class="col_1"></div>
    <div class="col_10">
        <h3>Customers List (Total: <?= $nums; ?>)</h3>
            ...
            <table>
                ...
                <?php do { ?>
                    <tr>
                        ...
                        <td>
                            <a href="updateCustomer.php?id=<?= $rows['id'] ?>"><i class="fa fa-edit"></i></a>
                            <a onclick="return confirmation()" href="deleteCustomer.php?id=<?= $rows['id'] ?>"><i class="fa fa-minus-square"></i></a>
                        </td>
                    </tr>
